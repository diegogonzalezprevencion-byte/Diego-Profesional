...
create table if not exists public.testimonios (
  ...
  categoria text not null check (categoria in ('prevencion', 'masoterapia', 'general')),
...
values
('Cliente Empresa', 'Administración', 'Empresa de Servicios', 'Nos ayudó a ordenar documentación preventiva y mejorar la gestión interna.', 'prevencion', true),
...
values
('Capacitación preventiva', 'Espacio para fotografía de capacitación o charla de seguridad.', 'prevencion', '', true),
('Box de masoterapia', 'Espacio para fotografía de camilla, ambiente y equipamiento.', 'masoterapia', '', true)
on conflict do nothing;
