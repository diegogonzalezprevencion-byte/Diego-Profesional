      ...
      <section className="section">
        <div className="container">
          ...
          <p>
            ...
            la gestión documental, la capacitación y el control preventivo dentro de la organización.
          </p>
          ...
          <div className="cta">
            ...
            <p>
              En la siguiente fase se integrará el calendario de autoagendamiento para reuniones,
              diagnósticos y visitas técnicas.
            </p>
          </div>
        </div>
      </section>
