...
export const metadata = {
  ...
  description: "Servicios de prevención de riesgos, regularización legal, matrices de riesgos, informes de gestión y capacitaciones en Chile."
};
    ...
    <main>
      <section className="section">
        <div className="container">
          ...
          <p>Acompañamiento profesional para fortalecer cumplimiento legal, gestión documental y control preventivo.</p>
          <div className="grid-3" style={{ marginTop: 28 }}>
            {services.map((service) => <div className="card" key={service}><h3>{service}</h3><p>Servicio adaptable según rubro, tamaño de empresa, sucursal y requerimiento legal.</p></div>)}
          </div>
          <div className="cta">
