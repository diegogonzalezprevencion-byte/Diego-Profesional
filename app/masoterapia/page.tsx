...
export const metadata = {
  title: "Masoterapia Profesional",
  description: "Masajes relajantes, descontracturantes, piedras calientes, piernas cansadas y masaje mixto."
};
      ...
      <section className="section">
        <div className="container">
          ...
          <div className="grid-3" style={{ marginTop: 28 }}>
            {services.map((service) => <div className="card" key={service.name}><h3>{service.name}</h3><p>{service.duration}</p><div className="price">{service.price}</div></div>)}
          </div>
          <div className="cta">
