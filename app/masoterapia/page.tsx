    ...
    <main>
      <section className="section">
        <div className="container">
          ...
          <p>
            Servicios orientados al bienestar corporal, relajación, recuperación muscular
            y alivio de tensión física.
          </p>
          ...
          <div className="cta">
            ...
            <p>
              En la Fase 3 se incorporará calendario de reservas, horarios disponibles,
              bloqueo de agenda y panel de administración semanal.
            </p>
          </div>
        </div>
      </section>
