...
export const metadata = {
  ...
  description: "Agenda online para masoterapia profesional."
};
    ...
    <main>
      <section className="section">
        <div className="container">
          ...
          <p>Selecciona un día, revisa horarios disponibles y solicita tu reserva. El sistema preparará recordatorios.</p>
